...
#ifndef AEIF_CBVG1_2010_H
#define AEIF_CBVG1_2010_H
 ...
 */
extern "C" int aeif_cbvg1_2010_dynamics( double, const double*, double*, void* );

class aeif_cbvg1_2010 : public Extended_Archiving_Node
{

public:
  aeif_cbvg1_2010();
  aeif_cbvg1_2010( const aeif_cbvg1_2010& );
  ~aeif_cbvg1_2010();
...
private:
  ...
  friend int aeif_cbvg1_2010_dynamics( double, const double*, double*, void* );

  // The next two classes need to be friends to access the State_ class/member
  friend class RecordablesMap< aeif_cbvg1_2010 >;
  friend class UniversalDataLogger< aeif_cbvg1_2010 >;
...
public:
  ...
  struct Buffers_
  {
    Buffers_( aeif_cbvg1_2010& );                  //!<Sets buffer pointers to 0
    Buffers_( const Buffers_&, aeif_cbvg1_2010& ); //!<Sets buffer pointers to 0

    //! Logger for all analog data
	UniversalDataLogger< aeif_cbvg1_2010 > logger_;
  ...
  static RecordablesMap< aeif_cbvg1_2010 > recordablesMap_;
};

inline port
aeif_cbvg1_2010::send_test_event( Node& target,
  rport receptor_type,
  synindex,
  bool )
{
...
inline port
aeif_cbvg1_2010::handles_test_event( SpikeEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline port
aeif_cbvg1_2010::handles_test_event( CurrentEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline port
aeif_cbvg1_2010::handles_test_event( DataLoggingRequest& dlr, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline void
aeif_cbvg1_2010::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
...
inline void
aeif_cbvg1_2010::set_status( const DictionaryDatum& d )
{
