...
template < typename targetidentifierT >
inline void
ClopathConnectionTD< targetidentifierT >::send( Event& e, thread t,
    const CommonSynapseProperties& cp)
{
  double t_spike = e.get_stamp().get_ms();
  /*
     We need to update the synapse if a spike arrives so that we compute the correct weight before
     the spike is transmitted.
     */
...
template < typename targetidentifierT >
inline void
ClopathConnectionTD< targetidentifierT >::time_driven_update( Time syn_update_stamp,
