...
ModelsModule::init( SLIInterpreter* )
{
  ...
  */
  ...
  register_connection_model< UrbanczikConnection >(
    "urbanczik_synapse", default_connection_model_flags |
    RegisterConnectionModelFlags::REQUIRES_URBANCZIK_ARCHIVING );
  register_connection_model< UrbanczikConnectionBC >(
    "urbanczik_synapse_bc", default_connection_model_flags |
    RegisterConnectionModelFlags::REQUIRES_URBANCZIK_ARCHIVING );
  register_connection_model< UrbanczikConnectionTD >(
    "urbanczik_synapse_td", default_connection_model_flags |
    RegisterConnectionModelFlags::REQUIRES_URBANCZIK_ARCHIVING );
